...
<div className="bg-amber-50 border-l-4 border-amber-400 p-4 mb-6 rounded-r-lg shadow-sm"> <div className="flex"> <AlertTriangle className="w-5 h-5 text-amber-600 mr-3 flex-shrink-0" /> <div> <h4 className="text-sm font-bold text-amber-800 mb-1"> 📊 DATA TRANSPARENCY NOTICE </h4> <p className="text-xs text-amber-700 leading-relaxed"> This analysis combines real data from public sources with AI-powered interpretation. While we strive for accuracy, AI analysis may contain errors, biases, or incomplete information. This is a research tool, not professional advice. Always conduct independent due diligence. </p> </div> </div> </div> );
// ============================================
// INVESTMENT DISCLAIMER
// ============================================
export const InvestmentDisclaimer: React.FC = () => (

<div className="mt-8 pt-6 border-t border-slate-200 text-center"> <p className="text-[10px] text-slate-400 max-w-2xl mx-auto leading-relaxed"> ⚖️ <strong>LEGAL DISCLAIMER:</strong> This report is for informational purposes only. It does not constitute financial, investment, legal, or professional advice. DemandOwl and its operators accept no liability for decisions, financial losses, or outcomes resulting from the use of this tool. All trademarks mentioned belong to their respective owners. </p> </div> );
// ============================================
// DEMO MODE BANNER
// ============================================
...
{onUpgrade && (
<button onClick={onUpgrade} className="bg-white text-indigo-600 px-4 py-2 rounded-lg font-semibold text-sm hover:bg-purple-50 transition-colors flex-shrink-0" >
Upgrade Now
</button>
)}
</div>
