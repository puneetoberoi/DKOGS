...
export const PrivacyPage: React.FC<{ onBack: () => void }> = ({ onBack }) => (
  <div className="max-w-3xl mx-auto px-4 py-12 animate-fade-in">
    ...
    <div className="prose prose-slate">
      ...
      <p>GapSpotter ("we", "our", "us") respects your privacy. This Privacy Policy explains how we collect, use, and protect your personal information.</p>
...
export const TermsPage: React.FC<{ onBack: () => void }> = ({ onBack }) => (
  <div className="max-w-3xl mx-auto px-4 py-12 animate-fade-in">
    ...
    <div className="prose prose-slate">
      ...
      <p>By accessing or using GapSpotter, you agree to be bound by these Terms of Service.</p>
      
      <h3>2. Description of Service</h3>
      <p>GapSpotter provides AI-powered market research and intelligence reports.</p>
      ...
      <p>GapSpotter is provided "as is". We make no warranties regarding the accuracy or completeness of the market data provided.</p>
    </div>
  </div>
);
